...
#                                          '5c16a2cd5b24519a3273f3c489a744f7'
#                                          '?d=identicon&s=80'))
...
#         self.assertEqual(u1.followed.first().username, 'razak')
#         self.assertEqual(u2.followers.count(), 1)
#         self.assertEqual(u2.followers.first().username, 'sue')
...
#         # create four posts
#         now = datetime.utcnow()
#         p1 = Post(body="post from sue", author=u1,
